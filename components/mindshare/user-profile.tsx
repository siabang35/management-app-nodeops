...
export function UserProfile({ user }: any) {
  ...
  const profileData = {
    ...
    xHandle: user.xHandle || "Not set",
    telegramId: user.telegramId || "Not set",
    discordId: user.discordId || "Not set",
    discordUsername: user.discordUsername || "Not set",
    ...
    >
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        ...
        <CardContent className="space-y-3">
          ...
          {/* Telegram */}
          {profileData.telegramId !== "Not set" && (
            <motion.div className="p-3 bg-slate-700/30 rounded-lg" whileHover={{ x: 4 }}>
